 ...
 */
angular.module('FileManagerApp').service('login', ['$q', '$rootScope', '$mdDialog', 'googleApi', 'fileManagerConfig', function ($q, $rootScope, $mdDialog, googleApi,  fileManagerConfig) {
  ...
  */
  ...
  var clientId = fileManagerConfig.clientId;
  var scope = fileManagerConfig.scope;
  /**
  ...
  this.isLoading = function(loading, result){
    loading = result;
  };
  /**
  ...
  this.showLoginDialog = function($event, user) {
    return $mdDialog.show({
      targetEvent: $event,
      templateUrl: fileManagerConfig.tplPath + "/login.html",
