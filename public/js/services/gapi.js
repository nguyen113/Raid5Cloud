...
angular.module('FileManagerApp').factory('googleApi', ['$rootScope', '$window', '$q', 'fileManagerConfig', function($rootScope, $window, $q, fileManagerConfig) {
  var googleApi = $q.defer();
  //var apiKey = fileManagerConfig.apiKey;
  var loadApis = fileManagerConfig.loadApis;
