...
angular.module('FileManagerApp').service('drive', ['$q', '$cacheFactory', 'googleApi', function($q, $cacheFactory, googleApi) {
  ...
  this.loadFile = function(fileId) {
    ...
    return googleApi.then(function(gapi) {
      ...
      console.log(combineAndStoreResults(responses[0].result, responses[1].body));
 ...
 /**
  ...
  this.getUserInfo = function (){
    ...
    // });
    //   // var request = gapi.client.drive.about.get({}).execute(function (perms) {
    //   //   console.log(perms);
      // 
    return 'testUser';
  };
