(function(angular) {
    ...
    angular.module('FileManagerApp').service('fileNavigator', [
        ...
        FileNavigator.prototype.list = function(user) {
            var self = this;
            ...
            $http.get(fileManagerConfig.listUrl + user, data).success(function(data) {
        ...
        FileNavigator.prototype.refresh = function(user) {
            var self = this;
            var path = self.currentPath.join('/');
            return self.list(user).then(function(data) {
